...
export function ConsultationView({ appointmentId, patientId, onClose }: ConsultationViewProps) {
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs sm:text-sm text-neutral-600">
                  {mockPatientData.age} years • {mockPatientData.gender} • {mockPatientData.visitReason}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-secondary-900">Hausa ⇄ English Translation</p>
                    <p className="text-sm text-secondary-700">
                      {isTranslationEnabled ? 'Real-time translation active' : 'Translation disabled'} • Patient speaks {mockPatientData.language}
                    </p>
                  </div>
                </div>
                <Button
                  ...
                  className={isTranslationEnabled ? 'bg-secondary-600 hover:bg-secondary-700' : ''}
                >
            ...
            <Card>
              ...
              <CardContent>
                <textarea
                  ...
                  onChange={(e) => updateClinicalNote('historyOfPresentIllness', e.target.value)}
          ...
          <div className="space-y-4 sm:space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Patient Medical History</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Medical History Sections */}
                  <div className="grid gap-6 md:grid-cols-2">
                    <div className="space-y-4">
                      <h4 className="font-semibold text-neutral-900">Previous Visits</h4>
                      <div className="space-y-3">
                        <div className="p-3 bg-neutral-50 rounded-lg border">
                          <div className="flex justify-between items-start mb-2">
                            <span className="text-sm font-medium text-neutral-900">Oct 15, 2024</span>
                            <span className="text-xs px-2 py-1 bg-success-100 text-success-800 rounded-full">Resolved</span>
                          </div>
                          <p className="text-sm text-neutral-700">Headache, prescribed paracetamol</p>
                          <p className="text-xs text-neutral-500 mt-1">Dr. Ibrahim Musa</p>
                        </div>
                        <div className="p-3 bg-neutral-50 rounded-lg border">
                          <div className="flex justify-between items-start mb-2">
                            <span className="text-sm font-medium text-neutral-900">Sep 28, 2024</span>
                            <span className="text-xs px-2 py-1 bg-success-100 text-success-800 rounded-full">Resolved</span>
                          </div>
                          <p className="text-sm text-neutral-700">Routine checkup, all normal</p>
                          <p className="text-xs text-neutral-500 mt-1">Dr. Fatima Ali</p>
                        </div>
                      </div>
                    </div>

                    <div className="space-y-4">
                      <h4 className="font-semibold text-neutral-900">Allergies & Medications</h4>
                      <div className="space-y-3">
                        <div className="p-3 bg-warning-50 rounded-lg border border-warning-200">
                          <h5 className="text-sm font-medium text-warning-800 mb-1">Known Allergies</h5>
                          <p className="text-sm text-warning-700">Penicillin - Skin rash</p>
                        </div>
                        <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <h5 className="text-sm font-medium text-blue-800 mb-1">Current Medications</h5>
                  ...
                  {/* Vital Signs History */}
                  <div>
                    <h4 className="font-semibold text-neutral-900 mb-4">Recent Vital Signs</h4>
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-neutral-200">
                            <th className="text-left py-2 px-3 font-medium text-neutral-700">Date</th>
                            <th className="text-left py-2 px-3 font-medium text-neutral-700">BP</th>
                            <th className="text-left py-2 px-3 font-medium text-neutral-700">Temp</th>
                            <th className="text-left py-2 px-3 font-medium text-neutral-700">Pulse</th>
                            <th className="text-left py-2 px-3 font-medium text-neutral-700">Weight</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-b border-neutral-100">
                            <td className="py-2 px-3 text-neutral-900">Oct 15, 2024</td>
                            <td className="py-2 px-3 text-neutral-700">120/80</td>
                            <td className="py-2 px-3 text-neutral-700">36.5°C</td>
                            <td className="py-2 px-3 text-neutral-700">72 bpm</td>
                            <td className="py-2 px-3 text-neutral-700">65 kg</td>
                          </tr>
                          <tr className="border-b border-neutral-100">
                            <td className="py-2 px-3 text-neutral-900">Sep 28, 2024</td>
                            <td className="py-2 px-3 text-neutral-700">118/78</td>
                            <td className="py-2 px-3 text-neutral-700">36.2°C</td>
                            <td className="py-2 px-3 text-neutral-700">68 bpm</td>
                            <td className="py-2 px-3 text-neutral-700">64 kg</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  {/* Family History */}
                  <div>
                    <h4 className="font-semibold text-neutral-900 mb-4">Family History</h4>
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="p-3 bg-neutral-50 rounded-lg">
                        <h5 className="text-sm font-medium text-neutral-900 mb-1">Maternal</h5>
                        <p className="text-sm text-neutral-700">Hypertension (Mother)</p>
                      </div>
                      <div className="p-3 bg-neutral-50 rounded-lg">
                        <h5 className="text-sm font-medium text-neutral-900 mb-1">Paternal</h5>
                        <p className="text-sm text-neutral-700">Diabetes Type 2 (Father)</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="hidden lg:block w-80 bg-white border-l border-neutral-200 p-6">
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-neutral-900 mb-3">Patient Information</h3>
              <div className="space-y-3">
                <div className="p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="p-3 bg-neutral-50 rounded-lg">
                  <p className="text-sm font-medium text-neutral-700">Primary Language</p>
                  <p className="text-neutral-900">{mockPatientData.language}</p>
                </div>
                <div className="p-3 bg-neutral-50 rounded-lg">
                  <p className="text-sm font-medium text-neutral-700">Visit Reason</p>
                  <p className="text-neutral-900">{mockPatientData.visitReason}</p>
                </div>
                <div className="p-3 bg-neutral-50 rounded-lg">
                  <p className="text-sm font-medium text-neutral-700">Demographics</p>
                  <p className="text-neutral-900">{mockPatientData.age} years, {mockPatientData.gender}</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="font-semibold text-neutral-900 mb-3">Session Status</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                  <span className="text-sm font-medium text-neutral-700">Recording</span>
                  <span className={`text-sm font-semibold ${isRecording ? 'text-error-600' : 'text-neutral-500'}`}>
                    {isRecording ? 'LIVE' : 'Stopped'}
                  </span>
                </div>
                <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                  <span className="text-sm font-medium text-neutral-700">Translation</span>
                  <span className={`text-sm font-semibold ${isTranslationEnabled ? 'text-success-600' : 'text-neutral-500'}`}>
