    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="backdrop-blur-xl bg-white/80 border-b border-white/20 shadow-lg px-3 sm:px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            <Button variant="ghost" size="sm" onClick={onClose} className="flex-shrink-0 hover:bg-white/50 p-2">
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            <div className="flex flex-col items-end">
              <div className="hidden sm:flex items-center space-x-1">
                <span className="text-xs text-neutral-500">{mockPatientData.language}</span>
              ...
              <span className="text-xs text-neutral-500 hidden sm:block">Recording Time</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 p-3 sm:p-4 space-y-3 sm:space-y-4 pb-20 sm:pb-4">
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
              <div className="flex justify-between sm:block">
                ...
                <span className="font-semibold text-neutral-900">#{mockPatientData.id}</span>
              </div>
              <div className="flex justify-between sm:block">
                <span className="text-neutral-500">Duration</span>
                <span className="font-semibold text-neutral-900">{formatDuration(recordingDuration)}</span>
              </div>
              <div className="flex justify-between sm:block sm:col-span-2">
                <span className="text-neutral-500">Language</span>
                <span className="font-semibold text-neutral-900">{mockPatientData.language} → English</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-blue-900 mb-1 break-words">
                            Patient reports chest pain radiating to left arm, started 2 hours ago...
                          </p>
                          <p className="text-xs text-blue-600 italic break-words">
                            Translation: Mai ciwon kirji da ke zuwa hannun hagu, ya fara sa'o'i 2 da suka wuce...
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-green-900 mb-1 break-words">
                            Can you describe the severity of the pain on a scale of 1 to 10?
                          </p>
                          <p className="text-xs text-green-600 italic break-words">
                            Translation: Za ka iya bayyana girman zafin a sikelin 1 zuwa 10?
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {isAIProcessing && (
                      <div className="flex items-center justify-center py-4">
                        <div className="flex items-center space-x-2 text-purple-600">
                          ...
                          <span className="text-sm">AI processing speech...</span>
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <Card className="backdrop-blur-xl bg-white/70 border border-white/30 shadow-lg">
            <CardHeader className="pb-3 px-3 sm:px-6 pt-3 sm:pt-6">
              <CardTitle className="text-sm sm:text-base">Translation History</CardTitle>
            </CardHeader>
            <CardContent className="px-3 sm:px-6 pb-3 sm:pb-6">
              <div className="h-32 sm:h-48 lg:h-64 overflow-y-auto">
                <div className="space-y-2 text-sm">
                  <div className="p-2 bg-neutral-50 rounded border-l-2 border-blue-400">
                    <p className="font-medium text-neutral-900 break-words">Chest pain</p>
                    <p className="text-neutral-600 text-xs break-words">Ciwon kirji</p>
                  </div>
                  <div className="p-2 bg-neutral-50 rounded border-l-2 border-green-400">
                    <p className="font-medium text-neutral-900 break-words">Severe pain</p>
                    <p className="text-neutral-600 text-xs break-words">Zafi mai tsanani</p>
                  </div>
                  <div className="p-2 bg-neutral-50 rounded border-l-2 border-purple-400">
                    <p className="font-medium text-neutral-900 break-words">Medical history</p>
                    <p className="text-neutral-600 text-xs break-words">Tarihin likitanci</p>
                  </div>
                </div>
              </div>
            </CardContent>
